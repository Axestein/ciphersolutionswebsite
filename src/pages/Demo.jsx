    ...
    <div id="demo" className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <button 
            ...
            className="group bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold transition-all transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-3 mx-auto"
          >
            {isPlaying ? (
              <>
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          {/* Step Navigation */}
          <div className="flex flex-col lg:flex-row justify-center items-center space-y-4 lg:space-y-0 lg:space-x-8 mb-16">
            {steps.map((step, index) => (
              <div key={index} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <ArrowRight className="w-6 h-6 text-gray-400 ml-4 hidden lg:block" />
                )}
              </div>
            ))}
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                ...
                <div className="p-8 min-h-96">
                  ...
                  {activeStep === 0 && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600">Choose from 200+ integrations</p>
                      </div>
                      
                      <div className="grid grid-cols-3 gap-4">
                        {['Slack', 'Gmail', 'Salesforce', 'Shopify', 'Stripe', 'Zoom'].map((tool, index) => (
                          <div key={index} className={`p-4 border-2 rounded-lg text-center cursor-pointer transition-all ${
                            index < 3 ? 'border-green-200 bg-green-50' : 'border-gray-200 hover:border-blue-200'
                          }`}>
                            <div className="w-8 h-8 bg-gray-200 rounded mx-auto mb-2"></div>
                            <span className="text-sm font-medium text-gray-700">{tool}</span>
                            {index < 3 && <CheckCircle className="w-4 h-4 text-green-500 mx-auto mt-1" />}
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-blue-900 font-medium">3 integrations connected successfully!</span>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeStep === 1 && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="text-center mb-6">
                        <h3 className="text-xl font-semibold text-gray-900 mb-2">Build Your Workflow</h3>
                        <p className="text-gray-600">Drag and drop to create automation</p>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-blue-50 border border-blue-200 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="font-medium text-gray-900">When: New customer signs up</span>
                          </div>
                        ...
                        <div className="ml-6 border-l-2 border-gray-200 pl-6 space-y-3">
                          ...
                          <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                            <span className="text-gray-900">Add to CRM</span>
                            <Settings className="w-4 h-4 text-green-600" />
                          </div>
                          
                          <div className="flex items-center justify-between p-3 bg-purple-50 border border-purple-200 rounded-lg">
                            <span className="text-gray-900">Create Slack notification</span>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-green-900 font-medium">Workflow configured and ready to deploy!</span>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeStep === 2 && (
                    <div className="space-y-6 animate-fadeIn">
                      <div className="text-center mb-6">
                        <h3 className="text-xl font-semibold text-gray-900 mb-2">Monitor Performance</h3>
                        <p className="text-gray-600">Real-time insights and optimization</p>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-sm font-medium text-gray-700">Workflow Performance</span>
                      ...
                      <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-purple-900 mb-1">AI Insight</div>
                            <div className="text-sm text-purple-800">Your email automation is 35% more effective than industry average. Consider scaling this workflow.</div>
                          </div>
                        </div>
                      </div>
                    </div>
